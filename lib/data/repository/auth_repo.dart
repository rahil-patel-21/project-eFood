...
class AuthRepo {
  ...
  AuthRepo({@required this.dioClient, @required this.sharedPreferences, @required this.fcm});
  ...
  Future<ApiResponse> updateToken() async {
    try {
      String _deviceToken;
      if (Platform.isIOS) {
        fcm.onIosSettingsRegistered.listen((data) async {
      ...
      fcm.subscribeToTopic(AppConstants.TOPIC);
      Response response = await dioClient.post(
  ...
  Future<bool> clearSharedData() async {
    await fcm.unsubscribeFromTopic(AppConstants.TOPIC);
