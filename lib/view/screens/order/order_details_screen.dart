                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Row(children: [
                      ...
                      Expanded(child: SizedBox()),
                      order.trackModel.orderType == 'delivery' ? FlatButton.icon(
                        onPressed: () {
                    ...
                    Row(children: [
                      ...
                      Expanded(flex: 8, child: Row(children: [
                        ...
                        (order.trackModel.paymentStatus != 'paid' && order.trackModel.paymentMethod != 'cash_on_delivery'
                          ...
                          onTap: () {
                            showDialog(context: context, child: ChangeMethodDialog(orderID: order.trackModel.id.toString(), callback: (String message, bool isSuccess) {
