                ...
                Container(
                  ...
                  child: !locationProvider.isLoading ? CustomButton(
                    ...
                    onTap: locationProvider.loading ? null : () {
                      ...
                      if(!_isAvailable) {
                        Scaffold.of(context).showSnackBar(SnackBar(content: Text(getTranslated('service_is_not_available', context)), backgroundColor: Colors.red));
                      }else {
                          ...
                          locationProvider.addAddress(addressModel).then((value) {
                            if (value.isSuccess) {
                              if (fromCheckout) {
                                ...
                                Scaffold.of(context).showSnackBar(SnackBar(content: Text(value.message), backgroundColor: Colors.green));
                              }
                            } else {
                              Scaffold.of(context).showSnackBar(SnackBar(content: Text(value.message), backgroundColor: Colors.red));
                            }
                          });
                        }
                      }
